                        ...
                        sect2_WxType *WxType, char f_verbose, myMaparam *map)
{
   ...
   char namesN[][11] = {
      ...
      "NDFDWxCode",
      "Weather 1", "WX-Inten 1", "Cover 1", "Hazard 1",
      "Weather 2", "WX-Inten 2", "Cover 2", "Hazard 2",
      "Weather 3", "WX-Inten 3", "Cover 3", "Hazard 3",
      "Weather 4", "WX-Inten 4", "Cover 4", "Hazard 4",
      "Weather 5", "WX-Inten 5", "Cover 5", "Hazard 5",
   };                   /* Field (column) names. */
   char namesV[][11] = {
      "POINTID", "X", "Y", "LON", "LAT",
