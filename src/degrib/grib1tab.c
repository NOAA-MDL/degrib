...
GRIB1ParmTable parm_table_ncep_opn[256] = {
   ...
   /* 211 */ {"USWRF", "upward short wave rad. flux", "W/m^2", UC_NONE},
   /* 212 */ {"ULWRF", "upward long wave rad. flux", "W/m^2", UC_NONE},
   ...
   /* 241 */ {"LRGHR", "Large scale condensate heat rate", "K/s", UC_NONE},
...
GRIB1ParmTable parm_table_nceptab_129[256] = {
   ...
   /* 130 */ {"CWR", "Probability of Wetting Rain; exceeding 0.10" in a given time period", "%", UC_NONE},
...
GRIB1ParmTable parm_table_nceptab_133[256] = {
   /* 0 */ {"var0", "undefined", "-", UC_NONE},
   /* 1 */ {"PRES", "Pressure", "Pa", UC_NONE},
   /* 2 */ {"PRMSL", "Pressure reduced to MSL", "Pa", UC_NONE},
   /* 3 */ {"PTEND", "Pressure tendency", "Pa/s", UC_NONE},
   ...
   /* 152 */ {"var152", "undefined", "-", UC_NONE},
   /* 153 */ {"var153", "undefined", "-", UC_NONE},
   /* 154 */ {"OMGALF", "Omega (Dp/Dt) divide by density", "K", UC_NONE},
   ...
   /* 199 */ {"var199", "undefined", "-", UC_NONE},
   /* 200 */ {"var200", "undefined", "-", UC_NONE},
   /* 201 */ {"THZ0", "Potential temperature at top of viscous sublayer", "K", UC_NONE},
   ...
   /* 217 */ {"var217", "undefined", "-", UC_NONE},
   /* 218 */ {"var218", "undefined", "-", UC_NONE},
   /* 219 */ {"CNVDEMF", "Convective detrainment mass flux", "-", UC_NONE},
   /* 220 */ {"COVVVVV", "Convariance between vertical and vertical components of the wind", "-", UC_NONE},
   /* 221 */ {"var221", "undefined", "-", UC_NONE},
   /* 222 */ {"var222", "undefined", "-", UC_NONE},
   /* 223 */ {"var223", "undefined", "-", UC_NONE},
   /* 224 */ {"var224", "undefined", "-", UC_NONE},
...
/* Updated last on 8/25/2008 */
GRIB1ParmTable parm_table_nceptab_140[256] = {
   /* 0 */ {"var0", "undefined", "-", UC_NONE},
   /* 1 */ {"PRES", "Pressure", "Pa", UC_NONE},
   /* 2 */ {"PRMSL", "Pressure reduced to MSL", "Pa", UC_NONE},
   /* 3 */ {"PTEND", "Pressure tendency", "Pa/s", UC_NONE},
...
/* Updated last on 8/25/2008 */
GRIB1ParmTable parm_table_nceptab_141[256] = {
   /* 0 */ {"var0", "undefined", "-", UC_NONE},
   /* 1 */ {"PRES", "Pressure", "Pa", UC_NONE},
   /* 2 */ {"PRMSL", "Pressure reduced to MSL", "Pa", UC_NONE},
   /* 3 */ {"PTEND", "Pressure tendency", "Pa/s", UC_NONE},
   ...
   /* 188 */ {"HO2", "Hydroperoxyl Radical", "-", UC_NONE},
   /* 189 */ {"var189", "undefined", "-", UC_NONE},
   /* 190 */ {"var190", "undefined", "-", UC_NONE},
   /* 191 */ {"var191", "undefined", "-", UC_NONE},
   /* 192 */ {"var192", "undefined", "-", UC_NONE},
   ...
   /* 198 */ {"var198", "undefined", "-", UC_NONE},
   /* 199 */ {"var199", "undefined", "-", UC_NONE},
   /* 200 */ {"ASO4", "Sulfate Particulates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 201 */ {"ANH4", "Ammonia Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 202 */ {"ANO3", "Nitrate Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 203 */ {"AORGA", "Organic Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 204 */ {"AORGPA", "Primarily Organic Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 205 */ {"AORGB", "Biogenically Originated Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 206 */ {"AEC", "Elemental Carbon Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 207 */ {"A25", "Unspecified Anthropogenic Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 208 */ {"AH2O", "Water Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 209 */ {"ANA", "Sodium Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 210 */ {"ACL", "Chlroide Pariculates <= 2.5 um Diameter", "ug/m^3", UC_NONE},
   /* 211 */ {"var211", "undefined", "-", UC_NONE},
   /* 212 */ {"var212", "undefined", "-", UC_NONE},
   /* 213 */ {"var213", "undefined", "-", UC_NONE},
   /* 214 */ {"var214", "undefined", "-", UC_NONE},
   /* 215 */ {"var215", "undefined", "-", UC_NONE},
   /* 216 */ {"ASO4K", "Sulfate Particulates between 2.5 and 10 um Diameter", "ug/m^3", UC_NONE},
   /* 217 */ {"ANAK", "Sodium Particulates between 2.5 and 10 um Diameter", "ug/m^3", UC_NONE},
   /* 218 */ {"ACLK", "Chloride Particulates between 2.5 and 10 um Diameter", "ug/m^3", UC_NONE},
   /* 219 */ {"ASEAS", "Sea Salt Originated Particulates between 2.5 and 10 um Diameter", "ug/m^3", UC_NONE},
   /* 220 */ {"ASOIL", "Crustal Material Originated Particulates between 2.5 and 10 um Diameter", "ug/m^3", UC_NONE},
   /* 221 */ {"ACORS", "Particulates between 2.5 and 10 um Diameter", "ug/m^3", UC_NONE},
   /* 222 */ {"NUMATKN", "Number Concentration Particulates between 2.5 and 0.1 um Diameter", "number/m^3", UC_NONE},
   /* 223 */ {"NUMACC", "Number Concentration Particulates between 2.5 and 2.5 um Diameter", "number/m^3", UC_NONE},
   /* 224 */ {"NUMCOR", "Number Concentration Particulates between 2.5 and 10 um Diameter", "number/m^3", UC_NONE},
   /* 225 */ {"var225", "undefined", "-", UC_NONE},
   /* 226 */ {"var226", "undefined", "-", UC_NONE},
   /* 227 */ {"var227", "undefined", "-", UC_NONE},
   /* 228 */ {"SRFATKN", "Surface Area Contributed by Particulates <= 0.1 um Diameter", "m^2/m^3", UC_NONE},
   /* 229 */ {"SRFACC", "Surface Area Contributed by Particulates between 0.1 and 2.5 um Diameter", "m^2/m^3", UC_NONE},
   /* 230 */ {"var230", "undefined", "-", UC_NONE},
   /* 231 */ {"var231", "undefined", "-", UC_NONE},
   /* 232 */ {"SO2", "Sulfur Dioxide", "ppbV", UC_NONE},
   /* 233 */ {"MSA", "Methanesulfonic Acid", "Kg/Kg", UC_NONE},
   /* 234 */ {"TSO4", "Total Sulfate Particulates Fine and Coarse)", "ug/m^3", UC_NONE},
   /* 235 */ {"DMS", "Dimethylsulfide", "Kg/Kg", UC_NONE},
   /* 236 */ {"var236", "undefined", "-", UC_NONE},
   /* 237 */ {"var237", "undefined", "-", UC_NONE},
   /* 238 */ {"var238", "undefined", "-", UC_NONE},
   /* 239 */ {"var239", "undefined", "-", UC_NONE},
   /* 240 */ {"DU1", "Dust Particulates between 0.2 and 2.0 um Diameter", "Kg/Kg", UC_NONE},
   /* 241 */ {"DU2", "Dust Particulates between 2.0 and 3.6 um Diameter", "Kg/Kg", UC_NONE},
   /* 242 */ {"DU3", "Dust Particulates between 3.6 and 6.0 um Diameter", "Kg/Kg", UC_NONE},
   /* 243 */ {"DU4", "Dust Particulates between 6.0 and 12.0 um Diameter", "Kg/Kg", UC_NONE},
   /* 244 */ {"DU5", "Dust Particulates between 12.0 and 20.0 um Diameter", "Kg/Kg", UC_NONE},
   /* 245 */ {"SS1", "Sea Salt Particulates between 0.2 and 1.0 um Diameter", "Kg/Kg", UC_NONE},
   /* 246 */ {"SS2", "Sea Salt Particulates between 1.0 and 3.0 um Diameter", "Kg/Kg", UC_NONE},
   /* 247 */ {"SS3", "Sea Salt Particulates between 3.0 and 10.0 um Diameter", "Kg/Kg", UC_NONE},
   /* 248 */ {"SS4", "Sea Salt Particulates between 10.0 and 20.0 um Diameter", "Kg/Kg", UC_NONE},
...
/* *INDENT-OFF* */
GRIB1ParmTable parm_table_norway128[256] = {
   /* 0 */ {"var0", "undefined", "-", UC_NONE},
