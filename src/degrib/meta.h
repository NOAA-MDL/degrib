...
enum { NDFD_MAX=0, NDFD_MIN=1, NDFD_POP=2, NDFD_TEMP=3, NDFD_WD=4,
       ...
       NDFD_CUM34=19, NDFD_CUM50=20, NDFD_CUM64=21, NDFD_FWXWINDRH=22,
       NDFD_FWXTSTORM=23, NDFD_CONHAZ=24,
       NDFD_PTORN=25, NDFD_PHAIL=26, NDFD_PTSTMWIND=27, NDFD_PXTORN=28,
       NDFD_PXHAIL=29, NDFD_PXTSTMWIND=30, NDFD_PSTORM=31, NDFD_PXSTORM=32,
       NDFD_TMPABV14D=33, NDFD_TMPBLW14D=34, NDFD_PRCPABV14D=35,
       NDFD_PRCPBLW14D=36, NDFD_TMPABV30D=37, NDFD_TMPBLW30D=38,
       NDFD_PRCPABV30D=39, NDFD_PRCPBLW30D=40, NDFD_TMPABV90D=41,
       NDFD_TMPBLW90D=42, NDFD_PRCPABV90D=43, NDFD_PRCPBLW90D=44,
       LAMP_TSTMPRB=45, RTMA_PRECIPA=46, RTMA_SKY=47, RTMA_TD=48,
       RTMA_TEMP=49, RTMA_UTD=50, RTMA_UTEMP=51, RTMA_UWDIR=52,
       RTMA_UWSPD=53, RTMA_WDIR=54, RTMA_WSPD=55
#ifdef GFSEKD
       GFSEKDMOS_MAXT=56, GFSEKDMOS_MINT=57,
       GFSEKDMOS_TEMP=58, GFSEKDMOS_TD=59, GFSEKDMOS_QPF=60,
#endif
...
enum { NDFD_MAX, NDFD_MIN, NDFD_POP, NDFD_TEMP, NDFD_WD, NDFD_WS,
       ...
       LAMP_TSTMPRB, RTMA_PRECIPA, RTMA_SKY, RTMA_TD, RTMA_TEMP, RTMA_UTD, 
       RTMA_UTEMP, RTMA_UWDIR, RTMA_UWSPD, RTMA_WDIR, RTMA_WSPD,
#ifdef GFSEKD
