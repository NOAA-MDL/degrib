...
enum { NDFD_MAX, NDFD_MIN, NDFD_POP, NDFD_TEMP, NDFD_WD, NDFD_WS,
       ...
       NDFD_PRCPABV90D, NDFD_PRCPBLW90D, RTMA_PRECIPA, RTMA_SKY, RTMA_TD,
       RTMA_TEMP, RTMA_UTD, RTMA_UTEMP, RTMA_UWDIR, RTMA_UWSPD, RTMA_WDIR,
       RTMA_WSPD, RTMA_NDFD_SKY, RTMA_NDFD_PRECIPA, RTMA_NDFD_TD,
       RTMA_NDFD_TEMP, RTMA_NDFD_WDIR, RTMA_NDFD_WSPD, NDFD_UNDEF,
       NDFD_MATCHALL
};
#endif
