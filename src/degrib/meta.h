...
enum { NDFD_MAX=0, NDFD_MIN=1, NDFD_POP=2, NDFD_TEMP=3, NDFD_WD=4,
       ...
       NDFD_TMPBLW90D=43, NDFD_PRCPABV90D=44, NDFD_PRCPBLW90D=45,
       LAMP_TSTMPRB=46, RTMA_PRECIPA=47, RTMA_SKY=48, RTMA_TD=49,
       RTMA_TEMP=50, RTMA_UTD=51, RTMA_UTEMP=52, RTMA_UWDIR=53,
       RTMA_UWSPD=54, RTMA_WDIR=55, RTMA_WSPD=56
#ifdef GFSEKD
       GFSEKDMOS_MAXT=57, GFSEKDMOS_MINT=58,
       GFSEKDMOS_TEMP=59, GFSEKDMOS_TD=60, GFSEKDMOS_QPF=61,
#endif
