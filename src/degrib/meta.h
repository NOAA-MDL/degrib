...
enum { NDFD_MAX, NDFD_MIN, NDFD_POP, NDFD_TEMP, NDFD_WD, NDFD_WS,
       ...
       NDFD_PSTORM, NDFD_PXSTORM, NDFD_TEMP814ABV, NDFD_TEMP814BEL,
       NDFD_PRECIP814ABV, NDFD_PRECIP814BEL, NDFD_TEMPMONTHABV,
       NDFD_TEMPMONTHBEL, NDFD_PRECIPMONTHABV, NDFD_PRECIPMONTHBEL,
       NDFD_TEMP3MONTHABV, NDFD_TEMP3MONTHBEL, NDFD_PRECIP3MONTHABV,
       NDFD_PRECIP3MONTHBEL, NDFD_UNDEF, NDFD_MATCHALL
};
*/
enum { NDFD_MAX, NDFD_MIN, NDFD_POP, NDFD_TEMP, NDFD_WD, NDFD_WS,
       NDFD_TD, NDFD_SKY, NDFD_QPF, NDFD_SNOW, NDFD_WX, NDFD_WH,
