...
enum { NDFD_MAX=0, NDFD_MIN=1, NDFD_POP=2, NDFD_TEMP=3, NDFD_WD=4,
       ...
       NDFD_WWA=15, NDFD_INC34=16, NDFD_INC50=17, NDFD_INC64=18,
       NDFD_CUM34=19, NDFD_CUM50=20, NDFD_CUM64=21, NDFD_CONHAZ=22,
       NDFD_PTORN=23, NDFD_PHAIL=24, NDFD_PTSTMWIND=25, NDFD_PXTORN=26,
       NDFD_PXHAIL=27, NDFD_PXTSTMWIND=28, NDFD_PSTORM=29, NDFD_PXSTORM=30,
       ...
       LAMP_TSTMPRB=43, RTMA_PRECIPA=44, RTMA_SKY=45, RTMA_TD=46,
       RTMA_TEMP=47, RTMA_UTD=48, RTMA_UTEMP=49, RTMA_UWDIR=50,
       RTMA_UWSPD=51, RTMA_WDIR=52, RTMA_WSPD=53
#ifdef GFSEKD
       GFSEKDMOS_MAXT=54, GFSEKDMOS_MINT=55,
       GFSEKDMOS_TEMP=56, GFSEKDMOS_TD=57, GFSEKDMOS_QPF=58,
#endif
...
enum { NDFD_MAX, NDFD_MIN, NDFD_POP, NDFD_TEMP, NDFD_WD, NDFD_WS,
       ...
       NDFD_INC64, NDFD_CUM34, NDFD_CUM50, NDFD_CUM64, NDFD_CONHAZ,
       NDFD_PTORN, NDFD_PHAIL, NDFD_PTSTMWIND, NDFD_PXTORN, NDFD_PXHAIL,
       NDFD_PXTSTMWIND, NDFD_PSTORM, NDFD_PXSTORM, NDFD_TMPABV14D,
       ...
       NDFD_TMPBLW90D, NDFD_PRCPABV90D, NDFD_PRCPBLW90D, LAMP_TSTMPRB, 
       RTMA_PRECIPA, RTMA_SKY, RTMA_TD, RTMA_TEMP, RTMA_UTD, RTMA_UTEMP, 
       RTMA_UWDIR, RTMA_UWSPD, RTMA_WDIR, RTMA_WSPD,
#ifdef GFSEKD
...
enum { GB1S2_LATLON = 0, GB1S2_MERCATOR = 1, GB1S2_LAMBERT = 3,
       GB1S2_POLAR = 5, GB1S2_ROTATED = 10
};
...
enum { GS4_ANALYSIS, GS4_ENSEMBLE, GS4_DERIVED, GS4_PROBABIL_PNT = 5,
   GS4_PERCENT_PNT = 6, GS4_ERROR = 7, GS4_STATISTIC = 8, GS4_PROBABIL_TIME = 9,
   GS4_PERCENT_TIME = 10, GS4_ENSEMBLE_STAT = 11, GS4_DERIVED_INTERVAL = 12,
