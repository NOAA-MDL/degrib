...
*/
         ...
         printf ("      sigtornprob pxtornado xt 'Extreme Tornado Probability'\n");
         printf ("      sighailprob pxhail xh 'Extreme Hail Probability'\n");
         printf ("      sigwindprob pxtstmwinds xw 'Extreme Thunderstorm Wind Probability'\n");
         printf ("      totalproboutlook ptotsvrtstm ps 'Total Probability of Severe Thunderstorms'\n");
         printf ("      sigtotproboutlook pxtotsvrtstm xs 'Total Probability of Extreme Severe Thunderstorms'\n");
