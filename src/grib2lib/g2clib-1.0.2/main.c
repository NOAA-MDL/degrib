...
extern template *getdrstemplate(int);
extern template *extdrstemplate(int,g2int *);
extern template *getgridtemplate(int);
extern template *extgridtemplate(int,g2int *);
extern template *getpdstemplate(int);
extern template *extpdstemplate(int,g2int *);
