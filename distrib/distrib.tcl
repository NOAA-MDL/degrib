...
puts "----------"
puts "Recommend updated degrib/history.txt"
puts ""
...
puts ""
puts "Add the full download URL to the Release notes"
puts ""
puts "When finished, remember to tag it using:"
puts "svn copy -r747 http://slosh.nws.noaa.gov/svn/degrib/degrib"
puts "  http://slosh.nws.noaa.gov/svn/degrib/tags/20080724-1.92-747"
puts "  -m 'Tagging release 1.92 (revision 747)'"
