...
#
# ActiveState ActiveTcl 8.5.9.1.294121 Win32/x86, Thu Dec 02 22:37:30 PST 2010
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1291358250}
	buildtime,fmt {Thu Dec 02 22:37:30 PST 2010}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.9.1.294121 Win32/x86 @ Thu Dec 02 22:37:30 PST 2010 / normal}
    }
}

package provide {ActiveTcl} {8.5.9.1.294121}
